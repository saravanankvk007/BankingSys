    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(url('do-register')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="first_name" value="<?php echo e(old('first_name')); ?>"  autocomplete="last_name" />
...
unset($__errorArgs, $__bag); ?>" name="last_name" value="<?php echo e(old('last_name')); ?>"  autocomplete="last_name" />
...
unset($__errorArgs, $__bag); ?>" name="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>"  autocomplete="date_of_birth">
...
unset($__errorArgs, $__bag); ?>" name="password"  autocomplete="new-password" value="<?php echo e(old('password')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Confirm Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" autocomplete="new-password" value="<?php echo e(old('password_confirmation')); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Laravel-MyTesting-Learn\BankingSys\resources\views/auth/register.blade.php ENDPATH**/ ?>